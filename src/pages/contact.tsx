    ...
    <>
      ...
      <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900">Bug Reports &amp; Suggestions</h2>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      ...
                      <a href="mailto:admin@toolisk.com" className="text-indigo-600 hover:underline">
                        admin@toolisk.com
                      </a>{' '}
                ...
                <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                  <span className="text-green-600 mt-0.5">✓</span>
                  <div>
                    <p className="text-sm font-medium text-gray-900">Tool Suggestions</p>
                    <p className="text-xs text-gray-500">
                      Email us at <a href="mailto:admin@toolisk.com" className="text-indigo-600 hover:underline">admin@toolisk.com</a> with
                ...
                <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                  <span className="text-green-600 mt-0.5">✓</span>
                  <div>
                    <p className="text-sm font-medium text-gray-900">Accuracy Reports</p>
                    <p className="text-xs text-gray-500">
          ...
          <div className="mt-6 bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center text-lg">
                🔧
              </div>
              <div className="flex-1">
                <h2 className="text-lg font-bold text-gray-900 mb-2">Actively Maintained</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-blue-50 rounded-lg p-4">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-sm font-semibold text-gray-900">Bug Reviews</h3>
                    </div>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-2xl">✨</span>
                      <h3 className="text-sm font-semibold text-gray-900">Regular Updates</h3>
                    </div>
                    <p className="text-xs text-gray-600">
