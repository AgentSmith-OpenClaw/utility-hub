      ...
      <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">About Toolisk</h1>
            <p className="mt-2 text-gray-500">The story behind the tools</p>
          </div>

          {/* Content Card */}
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-10 max-w-none">
            ...
            {/* Who's Behind It */}
            <section className="mb-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Who&apos;s Behind Toolisk</h2>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed mt-4">
                Have a tool suggestion? <Link href="/contact" className="text-indigo-600 font-medium hover:underline">Let us know</Link> — feedback helps prioritize what gets built next.
              </p>
            </section>
          </div>
        </div>
