...
const financeTools: FinanceTool[] = [
  ...
  },
  {
    ...
    description:
      'Calculate take-home pay with federal and state tax, FICA, and pre-tax deductions. Covers all 50 states with 2025 tax brackets.',
  ...
  },
  {
    name: 'EMI Calculator',
    description:
      'Advanced loan EMI calculator for home, car, and personal loans. Compare reduce-EMI vs reduce-tenure prepayment strategies, charts, and Excel export.',
  ...
  },
  {
    ...
    description:
      'Calculate your Financial Independence Retire Early number. Compare Lean, Fat, Coast, and Barista FIRE strategies with portfolio projections.',
  ...
  },
  {
    name: 'SIP Calculator',
    description:
      'Calculate Systematic Investment Plan returns with step-up options, goal planning, and long-term mutual fund projections.',
  ...
  },
  {
    ...
    description:
      'Compare buying versus renting with net worth analysis, opportunity cost, ownership expenses, and personalized housing recommendations.',
  ...
  },
  {
    ...
    description:
      'Calculate compound interest with flexible compounding frequencies, recurring contributions, inflation adjustment, and growth charts.',
  ...
  },
  {
    ...
    description:
      'Generate detailed amortization schedules for loans. See principal vs interest by month, remaining balance, and prepayment impact.',
  ...
  },
  {
    ...
    description:
      'Estimate monthly house payment including principal, interest, property taxes, insurance, and PMI for home purchase planning.',
  ...
  },
  {
    ...
    description:
      'Compare debt avalanche, snowball, and minimum-only payoff strategies with interest saved, payoff dates, and per-card schedules.',
  ...
  },
  {
    ...
    description:
      'Project retirement balances with employer match, salary growth, contribution limits, and safe withdrawal assumptions.',
  ...
  },
  {
    ...
    description:
      'Compare Roth IRA vs Traditional IRA after tax, including side-fund analysis, contribution limits, and retirement tax trade-offs.',
  ...
  },
  {
    ...
    description:
      'Calculate car loan payments with sales tax, trade-in, dealer fees, and side-by-side term comparisons from 36 to 84 months.',
  ...
  },
  {
    ...
    description:
      'Compare standard payoff, extra-payment, and refinance scenarios for student loans with multi-currency support.',
  ...
  },
  {
    ...
    description:
      'Project lump-sum and monthly investments with inflation adjustment, annual step-up, and DCA vs lump-sum comparison.',
  ...
  },
  {
    ...
    description:
      'Calculate cap rate, cash flow, cash-on-cash return, DSCR, 1% rule, GRM, and rental expense assumptions.',
  ...
  },
  {
    ...
    description:
      'Track assets and liabilities with allocation charts and benchmark comparisons by age to understand financial health.',
  ...
  },
  {
    ...
    description:
      "Use 1913-2026 US CPI data to compare purchasing power and see how the dollar's value changed over time.",
  ...
  },
  {
    ...
    description:
      'Add tax to a price or back it out with presets for US sales tax, EU/UK VAT, and Australian or Canadian GST/HST.',
  ...
  },
  {
    name: 'Tip Calculator',
    description:
      'Calculate tips, split bills, round totals, and review regional tipping etiquette across major markets.',
  ...
  },
  {
    name: 'FD Calculator',
    description:
      'Fixed Deposit calculator with quarterly compounding, senior citizen rates, TDS modeling, and post-tax maturity value.',
  ...
  },
  {
    name: 'RD Calculator',
    description:
      'Recurring Deposit calculator with month-by-month growth, quarterly compounding, and senior citizen rate support.',
  ...
  },
  {
    ...
    description:
      'Compute new salary from a hike percentage or calculate the hike percentage from a new offer. Annual or monthly, multi-currency.',
  ...
  },
  {
    ...
    description:
      'Compute sale price after percentage or flat discounts, with optional tax. Useful for shopping, invoices, and quick price checks.',
  ...
  },
  {
    ...
    description:
      'Estimate how much home you can afford from income, debts, down payment, PITI, and front/back DTI thresholds.',
  ...
  },
  {
    ...
    description:
      'Compare Social Security claiming ages, monthly benefits, lifetime totals, break-even points, and spousal benefit scenarios.',
...
export default function FinanceHome() {
  ...
  return (
    <>
      <Head>
        <title>Free Finance Calculators — 26 Tools for Loans, Retirement &amp; Investing | Toolisk</title>
        <meta
          name="description"
          content="Use 26 free finance calculators for loans, mortgages, tax, retirement, investing, savings, inflation, real estate, and everyday money decisions."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="Free Finance Calculators — 26 Tools for Loans, Retirement & Investing | Toolisk" />
        <meta
          property="og:description"
          content="26 free finance calculators for loans, mortgages, tax, retirement, investing, savings, inflation, and real estate decisions."
        />
        <meta property="og:url" content={`${SITE_URL}/finance`} />
        <meta property="og:type" content="website" />
        <meta name="twitter:title" content="Free Finance Calculators — 26 Tools for Loans, Retirement & Investing | Toolisk" />
        <meta
          name="twitter:description"
          content="26 free finance calculators for loans, mortgages, tax, retirement, investing, savings, and real estate."
        />
        <script
