...
const SLUG = '/utilities/unit-converter';
...
const FAQS = [
  ...
  { q: 'How accurate are the conversions?', a: 'All conversion factors are based on official SI and US customary definitions. Results are shown to 8 significant figures, which is more than sufficient for everyday use.' },
];
...
export default function UnitConverterPage() {
  ...
  return (
    <>
      ...
      <ToolShell icon="⚖️" title="Unit Converter" tagline="Convert between 50+ units of length, weight, temperature, volume, area, and speed — all in one place." parent="utilities" theme="amber">
        <UnitConverter />
      </ToolShell>
