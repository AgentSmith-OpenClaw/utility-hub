...
const SLUG = '/tools/pomodoro-timer';
...
export default function PomodoroTimerPage() {
  ...
  return (
    <>
      ...
      <ToolShell icon="🍅" title="Pomodoro Timer" tagline="Stay focused with 25-minute work sessions, 5-minute breaks, and a 15-minute rest every four sessions.">
        <PomodoroTimer />
      </ToolShell>
      ...
      <ToolSEOContent
        ...
        relatedTools={[
          { name: 'Age & Date Calculator', href: '/tools/age-calculator', icon: '📅' },
