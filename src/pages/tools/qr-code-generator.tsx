...
const SLUG = '/tools/qr-code-generator';
...
export default function QrCodeGeneratorPage() {
  ...
  return (
    <>
      ...
      <ToolShell icon="📱" title="QR Code Generator" tagline="Turn any URL, text, Wi-Fi credential, or contact into a downloadable QR code — PNG and SVG, fully in your browser.">
        <QrCodeGenerator />
      </ToolShell>
      ...
      <ToolSEOContent
        ...
        body={
          <section className="space-y-4">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              The modules along the edges alternate black-white to help the scanner determine cell size.
            </p>

            <h3 className="text-xl font-bold text-slate-900 mt-8">Best practices for printing</h3>
            <ul className="list-disc pl-6 space-y-1.5 text-slate-600">
              <li>Use SVG for print — it scales to any size without pixelation.</li>
              <li>Minimum print size is roughly 2 × 2 cm (≈ 0.8 in) for reliable scanning at arm&apos;s reach.</li>
              <li>Keep high contrast: black on white works best. Light-on-dark also works if contrast is strong.</li>
              <li>Include a short URL or &ldquo;Scan me&rdquo; label nearby — many people don&apos;t know what QR codes are for.</li>
              <li>Test the printed code with multiple devices before mass printing.</li>
            </ul>
        ...
        relatedTools={[
          ...
          { name: 'Image to Base64 Converter', href: '/tools/image-base64', icon: '🖼️' },
