...
const SLUG = '/tools/age-calculator';
...
export default function AgeCalculatorPage() {
  ...
  return (
    <>
      ...
      <ToolShell icon="📅" title="Age & Date Calculator" tagline="Find your exact age, count days between dates, or add days to any date — three tools in one.">
        <AgeCalculator />
      </ToolShell>
      ...
      <ToolSEOContent
        ...
        relatedTools={[
          ...
          { name: 'Pomodoro Timer', href: '/tools/pomodoro-timer', icon: '🍅' },
        ]}
      />
    </>
  );
