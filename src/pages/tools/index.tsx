...
import { TOOLS as tools } from '../../data/masterItems';
...
export default function ToolsHome() {
  ...
  return (
    <>
      <Head>
        <title>{`Toolisk Tools — ${tools.length} Free Online Developer & Productivity Utilities`}</title>
        <meta
          name="description"
          content={`${tools.length} free online utilities for developers, designers, and writers. JSON tools, subnet calculator, QR code generator, color contrast checker, cURL converter, and more — all client-side, private, no sign-ups.`}
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content={`${tools.length} free online utilities — subnet calculator, QR code generator, JSON diff, cURL converter, contrast checker, and more. Fast, private, no sign-ups.`}
        />
        <meta property="og:url" content="https://toolisk.com/tools" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content={`Toolisk Tools — ${tools.length} Free Online Developer & Productivity Utilities`} />
        <meta
          name="twitter:description"
          content={`${tools.length} free utilities for developers, designers, and writers. All run client-side.`}
        />
          ...
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-teal-50 flex items-center justify-center text-xl">⚡</div>
                <div>
                  <h2 className="text-sm font-bold text-slate-900 mb-1">{tools.length} tools, no friction</h2>
                  <p className="text-sm text-slate-500 leading-relaxed">
