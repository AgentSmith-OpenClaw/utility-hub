...
const SLUG = '/tools/percentage-calculator';
...
export default function PercentageCalculatorPage() {
  ...
  return (
    <>
      ...
      <ToolShell icon="%" title="Percentage Calculator" tagline="Find X% of Y, calculate percent change, add tips and discounts — four calculators in one.">
