export default function ImageTrustBadge() {
  return (
    <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 mb-4">
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-0 sm:divide-x sm:divide-slate-100">
        ...
        <div className="flex items-center gap-3 sm:flex-1 sm:pr-5">
          ...
          <div>
            <p className="text-xs font-semibold text-slate-800 leading-snug">Your images stay on your device — 100% private</p>
            <p className="text-[11px] text-slate-500 mt-0.5 leading-snug">Nothing is uploaded — ever. We never see your photos</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 sm:flex-1 sm:px-5">
          ...
          <div>
            <p className="text-xs font-semibold text-slate-800 leading-snug">Instant — no upload, no waiting</p>
        ...
        <div className="flex items-center gap-3 sm:flex-1 sm:pl-5">
          <div
            className="flex-shrink-0 w-9 h-9 rounded-lg bg-sky-50 flex items-center justify-center text-lg"
            aria-hidden="true"
          >
            🆓
          </div>
          <div>
            <p className="text-xs font-semibold text-slate-800 leading-snug">No sign-up, no watermark</p>
