...
export default function MarkdownPreview() {
  ...
  return (
    <div className="space-y-5">
      <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-3 flex items-center gap-3">
        <button
          type="button"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <ToolCard title="Markdown" action={<CopyButton value={input} disabled={!input} />}>
          <textarea
            ...
            spellCheck={false}
            className="w-full h-96 lg:h-[42rem] px-4 py-3 text-[13px] sm:text-sm font-mono bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-400 resize-none"
          />
        </ToolCard>
        ...
        >
          <div
            className="h-96 lg:h-[42rem] overflow-auto px-3 py-2.5 bg-white border border-slate-200 rounded-lg"
